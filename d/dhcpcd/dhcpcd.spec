...
%changelog
* Mon Dec 07 2020 Mikhail Efremov <sem@altlinux.org> 1:8.1.9-alt1
- Updated to 8.1.9.

* Thu Apr 02 2020 Mikhail Efremov <sem@altlinux.org> 1:8.1.7-alt1
- Updated to 8.1.7.

* Tue Jan 28 2020 Mikhail Efremov <sem@altlinux.org> 1:8.1.6-alt1
- Updated to 8.1.6.
...
* Fri Feb 08 2019 Mikhail Efremov <sem@altlinux.org> 1:7.1.1-alt1
- Updated to 7.1.1.
...
* Wed Jun 13 2018 Mikhail Efremov <sem@altlinux.org> 1:7.0.5b-alt1
- Updated to 7.0.5b.

* Thu May 03 2018 Mikhail Efremov <sem@altlinux.org> 1:7.0.4-alt1
- Updated to 7.0.4.

* Fri Apr 06 2018 Mikhail Efremov <sem@altlinux.org> 1:7.0.3-alt1
- Updated to 7.0.3.

* Tue Mar 27 2018 Mikhail Efremov <sem@altlinux.org> 1:7.0.2-alt1
- Drop obsoleted patch.
- Updated to 7.0.2.
