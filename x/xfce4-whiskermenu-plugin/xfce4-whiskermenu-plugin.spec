...
%changelog
* Tue May 26 2020 Mikhail Efremov <sem@altlinux.org> 2.3.5-alt2
- Use dm-tool for switch user command by default.
- Don't show menu and profile editors by default (closes: #38489).
